            ...
            {scheduleData.map((day) => (
              <div key={day.day} className="text-center relative flex-1 mx-12">
                ...
                <div className="relative z-30" style={{ transform: 'translate(0%, -40%)' }}>
                  {/* 序号 */}
                  <div className="mb-2">
                    <span className="text-4xl font-bold text-gray-400 font-number" style={{ fontFamily: 'MontserratNum', fontWeight: 700, fontSize: '100px', opacity: 0.1 }}>{day.day}</span>
                  </div>
                  {/* 日期 */}
                  <p className="font-semibold text-gray-800 mb-4" style={{ fontFamily: 'MontserratNum', fontWeight: 300, fontSize: 26 }}>
                    {day.date}
                  </p>
                  {/* 活动名称 */}
                  <p className="text-sm text-gray-600 mb-4" style={{ fontFamily: 'RalewayCustom', fontWeight: 700, fontSize: 20 }}>
                    {day.activityName}
                  </p>
                </div>
              </div>
            ...
            <div key={day.day} className="mb-6">
              ...
              <div className="w-full">
                {day.activities.map((activity, index) => (
                  ...
                  >
                    {/* 左侧时间矩形 */}
                    <div className="flex items-center justify-center text-gray-800 font-number" style={{ height: '30px', width: '100px', fontWeight: 400, backgroundColor: '#f3f4f6' }}>00:00</div>
